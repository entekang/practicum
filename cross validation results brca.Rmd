...
library(comprehenr)
library(quantreg)
brca <- readxl::read_excel("K:/Xuan_Li/Ente_Kang/BRCAdataset_fullcov.xlsx")
...
splits <- split(brcaosd, sample(1:10, nrow(brca1), replace = T))
...
splits <- split(brcadev, sample(1:10, nrow(brca1), replace = T))
